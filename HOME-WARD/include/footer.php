<footer class="full-row bg-secondary p-0">
            <div class="container">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-lg-4">
                                            <div class="footer-widget">
                                                ...
                                                <ul class="text-white">
                                                    <li class="hover-text-primary"><i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>KFUEIT, Rahim Yar Khan  </li>
                                                    <li class="hover-text-primary"> <a href="tel:+92307634748"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i> +92307634748 </a></li>
													<li  class="hover-text-primary"> <a href="tel:+92307634748"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i> +92307634748 </a></li>
                                                    <li class="hover-text-primary"> <a href="mailto:homeward@realestatest.com"><i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>homeward@realestatest.com </a> </li>
                                                </ul>
                                            </div>
                ...
                <div class="row copyright">
                    <div class="col-sm-6"> <span class="text-white">© <?php echo date('Y');?>Home-Ward Real Estate Website - Developed By KFUEIT(SWEN-7A)</span> </div>
                    <div class="col-sm-6">
